...
- Now, the rattlesnake information is added to the hidden state and the instructor approves
...
- Student types an action, and the agent reveals information and dynamically progresses through scenario
...
- Once the scenario is complete, a 3rd, Debrief agent summarizes the session and provides actionable feedback to prep students for the exam

### Conclusion
- Summit sim is a multi-agent Ai system with HITL to build infinitely many WFR scenarios
